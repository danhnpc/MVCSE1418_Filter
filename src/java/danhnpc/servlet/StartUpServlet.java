    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cookies != null) {
                ...
                String pasword = cookie.getValue();
                
                TblUsersDAO dao = new TblUsersDAO();
                boolean result = dao.checkLogin(userID, pasword);
            ...
            log("StartUpServlet_SQLException: " + e.getMessage());
        } catch (NamingException e) {
            log("StartUpServlet_NamingException: " + e.getMessage());
        } finally {
